<x-accounting::app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Cost Center</h2>
    ...
    <div class="py-6"><div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('settings.cost-centers.store') }}">
                @csrf
                @include('accounting::cost-centers.partials.form-fields')
