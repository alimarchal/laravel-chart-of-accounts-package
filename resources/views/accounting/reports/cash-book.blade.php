<x-accounting::app-layout>
    <x-slot name="header">
        <x-accounting::page-header title="Cash Book" backRoute="settings.dashboard" :showSearch="true" :showRefresh="true" :createRoute="null" createLabel="" />
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <x-accounting::filter-section :action="route('accounting.reports.cash-book')">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="mb-4 text-center print-header">
                    <h3 class="text-xl font-bold text-gray-800">Cash Book</h3>
                </div>
                @if($entries->isEmpty())
                <div class="text-center py-8 text-gray-500">No cash book entries found.</div>
                @else
