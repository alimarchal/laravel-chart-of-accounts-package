<x-accounting::app-layout>
    <x-slot name="header">
        <x-accounting::page-header title="Aged Receivables" backRoute="accounting.dashboard" :showSearch="false" :showRefresh="true" :createRoute="null" createLabel="" />
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="mb-4 text-center print-header">
                    <h3 class="text-xl font-bold text-gray-800">Aged Receivables</h3>
                    <p class="text-gray-600 mt-1 text-sm">As of {{ now()->format('F d, Y') }}</p>
                </div>
                @if($rows->isEmpty())
                <div class="text-center py-8 text-gray-500">No aged receivables found.</div>
                @else
