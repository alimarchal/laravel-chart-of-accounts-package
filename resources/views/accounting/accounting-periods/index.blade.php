<x-accounting::app-layout>
    <x-slot name="header">
        <x-accounting::page-header
            ...
            :createRoute="route('accounting.periods.create')"
    ...
    <x-accounting::data-table
        ...
        :emptyRoute="route('accounting.periods.create')"
            ...
            <tr class="border-b border-gray-200 text-sm hover:bg-gray-50">
                ...
                <td class="py-1 px-2 text-center">
                    <div class="flex justify-center space-x-2">
                        ...
                        @can('periods.update')
                        <a href="{{ route('accounting.periods.edit', $period) }}" class="inline-flex items-center justify-center w-8 h-8 text-green-600 hover:bg-green-100 rounded-md" title="Edit">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                        </a>
                        @endcan
                        @can('periods.delete')
                        <form method="POST" action="{{ route('accounting.periods.destroy', $period) }}" onsubmit="return confirm('Delete this period?')">
                            @csrf @method('DELETE')
