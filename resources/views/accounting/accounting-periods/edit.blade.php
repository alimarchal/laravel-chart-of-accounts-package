<x-accounting::app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Accounting Period</h2>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('settings.periods.update', $accountingPeriod) }}">
                    @csrf @method('PUT')
                    @include('accounting::accounting-periods.partials.form-fields', ['accountingPeriod' => $accountingPeriod])
                    <div class="flex items-center justify-end mt-6">
                        <x-accounting::button>Update Period</x-accounting::button>
                    </div>
                </form>
            </div>
        </div>
